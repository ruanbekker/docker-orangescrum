...
//Gmail SMTP
define("SMTP_HOST", "SENDGRID_HOSTNAME");
define("SMTP_PORT", "SENDGRID_PORT");
define("SMTP_UNAME", "SENDGRID_KEY");
...
define('SUPPORT_EMAIL', 'APP_SUPPORT_EMAIL'); //(REQUIRED) From Email
